...
const Landing = () => {
  return (
    <>
      ...
      <section
        className="flex w-full h-screen items-center justify-center text-center relative"
        id="home"
      >
        <div>
          <h2
        ...
        "
          ...
          >
            View my work{" "}
            <span className="group-hover:rotate-90 inline-block text-lg transition-transform duration-500">
              {"\u2192"}
            </span>
          </a>
        </div>
